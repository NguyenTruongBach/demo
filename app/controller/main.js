...
import {
    ...
    confirmAlert,
    errorAlert
} from '../controller/lib/sweetalert.js';

// Tạo các đối tượng mẫu
const student1 = new Student('0001', 'Le Thi A', 'HCM', 'lethia@gmail.com', '9', '9', '9.5');
const student2 = new Student('0002', 'Le Thi B', 'HN', 'lethib@gmail.com', '6.5', '6.5', '6');
const student3 = new Student('0003', 'Le Thi C', 'HG', 'lethic@gmail.com', '9', '9', '10');
const employee1 = new Employee('0004', 'Le Thi D', 'BD', 'lethid@gmail.com', '25', '250000');
const employee2 = new Employee('0005', 'Le Thi E', 'CT', 'lethie@gmail.com', '19', '230000');
const employee3 = new Employee('0006', 'Le Thi G', 'SL', 'lethig@gmail.com', '30', '350000');
const customer1 = new Customer('0007', 'Le Thi H', 'DT', 'lethih@gmail.com', 'CDNCorp', '250000', 'Tot');
const customer2 = new Customer('0008', 'Le Thi K', 'CM', 'lethik@gmail.com', 'MDNCorp', '480000', 'Kha');
const customer3 = new Customer('0009', 'Le Thi L', 'TB', 'lethil@gmail.com', 'JSXCorp', '140000', 'Trung Binh');
...
setUpList.addItem('ma', ['isRequired'], ['isBetween', {
    type: 'length',
    cur: 'ký tự',
    min: 4,
    max: 6
}]);
setUpList.addItem('ma', ['isDuplicate', {
    id: 'ma'
}]);
setUpList.addItem('hoTen', ['isRequired'], ['isName']);
setUpList.addItem('diaChi', ['isRequired']);
setUpList.addItem('email', ['isRequired'], ['isEmail']);
setUpList.addItem('toan', ['isRequired'], ['isBetween', {
    cur: 'điểm',
    min: 0,
    max: 10
}]);
setUpList.addItem('ly', ['isRequired'], ['isBetween', {
    cur: 'điểm',
    min: 0,
    max: 10
}]);
setUpList.addItem('hoa', ['isRequired'], ['isBetween', {
    cur: 'điểm',
    min: 0,
    max: 10
}]);
...
const taoDoiTuong = () => {
    ...
    let {
        value
    } = document.querySelector('#doiTuong');
    let person;
...
window.addEventListener('load', () => {
    ...
    document.querySelector('#SapXepTang').addEventListener('click', () => {
        ...
        let {
            value: doiTuong
        } = document.querySelector('#timDoiTuong');
